...
-- ===========================================
-- 8. ADD MISSING FOREIGN KEY CONSTRAINT TO PROJECTS
-- ===========================================
...
-- 4. epics (depends on projects, users, milestones, self-reference)
-- 5. sprints (depends on projects)
-- 6. tasks (depends on epics, sprints, users, self-reference)